...
from motorengine.errors import (ValidationError, InvalidDocumentError,
                                LookUpError)
from motorengine.python_support import (PY3, UNICODE_KWARGS, txt_type,
                                        to_str_keys_recursive)

from motorengine.base.common import get_document, ALLOW_INHERITANCE
from motorengine.base.datastructures import BaseDict, BaseList
from motorengine.base.fields import ComplexBaseField
...
class BaseDocument(object):
    ...
    def _build_index_spec(cls, spec):
        """Build a PyMongo index spec from a motorengine index spec.
        """
