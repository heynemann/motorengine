...
from motorengine import Document, EmbeddedDocument, connect
from motorengine.connection import get_db
from motorengine.fields import (BooleanField, GenericReferenceField,
...
class InheritanceTest(unittest.TestCase):
    ...
    def test_subclasses(self):
        ...
        self.assertEqual(Mammal._subclasses, ('Animal.Mammal', 'Animal.Mammal.Dog', 'Animal.Mammal.Human'))
