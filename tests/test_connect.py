...
class TestConnect(AsyncTestCase):
    ...
    def test_connect_to_replica_set(self):
        db = connect(host="localhost:27017,localhost:27018", replicaSet="rs0", port=4445, io_loop=self.io_loop)
    ...
    def test_connect_to_replica_set_with_invalid_replicaset_name(self):
        try:
            connect(host="localhost:27017,localhost:27018", replicaSet=0, port=4445, io_loop=self.io_loop)
